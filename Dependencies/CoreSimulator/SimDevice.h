...
@class NSArray, NSDictionary, NSMachPort, NSMutableArray, NSMutableDictionary, NSString, NSUUID, SimDeviceNotificationManager, SimDevicePasteboard, SimDeviceSet, SimDeviceType, SimRuntime;
@protocol OS_dispatch_queue, SimDeviceIOProtocol;
...
@property(retain, nonatomic) NSObject<SimDeviceIOProtocol> *io; // @synthesize io=_io;
